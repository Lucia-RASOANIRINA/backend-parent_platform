...
public class ResourceService {
    ...
    @Transactional
    public void removeRating(Long resourceId, Long userId) {
        resourceRatingRepository.deleteByResourceIdAndUserId(resourceId, userId);
        Double avg = resourceRatingRepository.getAverageRating(resourceId);
        Long count = resourceRatingRepository.countByResourceId(resourceId);
        resourceRepository.updateRatingStats(resourceId, avg == null ? 0.0 : avg, count == null ? 0L : count);
    }
